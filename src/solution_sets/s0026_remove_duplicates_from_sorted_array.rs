...
mod tests {
    ...
    #[test_case(vec![0,0,1,1,1,2,2,3,3,4],  &mut vec![0,1,2,3,4], 5; "example 1")]
    #[test_case(vec![1,1,2],  &mut vec![1,2], 2; "example 2")]
    fn test_26(nums: Vec<i32>, target: &mut Vec<i32>, length: i32) {
